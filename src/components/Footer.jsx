...
const SOCIAL_LINKS = [
  {
    label: 'GitHub',
    href: 'https://github.com/Era5mu55',
    icon: (
  ...
  {
    label: 'LinkedIn',
    href: 'https://www.linkedin.com/company/matowo-dev/',
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: 'WhatsApp',
    href: `https://wa.me/255786000551?text=${encodeURIComponent(
      "Hi Erasmus, I'm reaching out from your website."
    )}`,
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <div className={`container ${styles.inner}`}>
        ...
        <div className={styles.bottom}>
          <p className={styles.copy}>
            &copy; {year} Erasmus Matowo &mdash; matowodev.com. All rights reserved.
          </p>
